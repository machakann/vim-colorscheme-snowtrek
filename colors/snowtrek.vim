...
highlight DiffText guifg=NONE guibg=#f6f6e4 gui=undercurl guisp=#c29a16 ctermfg=NONE ctermbg=225 cterm=undercurl
highlight Directory guifg=#2053b4 guibg=NONE gui=NONE guisp=NONE ctermfg=19 ctermbg=NONE cterm=NONE
highlight Error guifg=#cd0000 guibg=NONE gui=undercurl guisp=#cd0000 ctermfg=124 ctermbg=NONE cterm=undercurl
